...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-left border-b border-border pb-4",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 border-t border-border pt-4",
      className
    )}
    {...props}
  />
